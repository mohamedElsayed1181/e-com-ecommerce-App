            ...
            {!accessToken ? (
              ...
              <div ref={menuRef}>
                <div className="inline-flex items-center overflow-hidden rounded-lg border bg-white shadow-md">
                  <a
                    href="#"
                    className="border-e px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100"
                  >
                    {`${user?.firistName} ${user?.secondName}`}
                  </a>
                  <button
                    onClick={() => setIsOpen(!isOpen)}
                    className="h-full p-2 text-gray-600 hover:bg-gray-100 hover:text-gray-800"
                  >
                ...
                {isOpen && (
                  ...
                  >
                    <div className="p-2 space-y-2">
                      ...
                      <NavLink
                        to="/login"
                        className="block rounded-md px-4 py-2 text-sm text-red-600 hover:bg-red-100"
                        role="menuitem"
